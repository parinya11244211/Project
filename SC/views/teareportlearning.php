...
$(document).ready(function(){				
	...
	// การเรียกใช้ slideBoxy(  picName  ,  ขนาดลูกศร  ,  ควาสูงของรูปทั้งหมด  ,  ความกว้างของรูปทั้งหมด  ,  ขนาดของเฟรม ใส่เป็น เท่า  , วินาทีที่จะเปลี่ยนรูปอัตโนมัติ);
		 });
</script>
...
<body>
  ...
  <?php foreach($showTopicLearning as $s){?>
   <!-- $showTopicLearning มาจาก Controller teachers Function getEventTopicLearning -->
    <tr>
